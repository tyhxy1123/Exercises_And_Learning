import com.javacode2018.mybatis.chat01.UserMapper;
import com.javacode2018.mybatis.chat01.UserModel;
import com.javacode2018.mybatis.chat01.UserUtil;
...
public class UserMapperTest {
    ...
    public void getModelListByIds() throws Exception {
        List<Integer> idList = Stream.of(2, 3, 4).collect(Collectors.toList());
        Map<String, Object> map = new HashMap<>();
